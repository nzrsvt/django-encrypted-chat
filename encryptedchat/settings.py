"""
Django settings for encryptedchat project.
...
SECRET_KEY = 'django-insecure-q+&w^xqt41-b4in#(j2br%off3qvvw6b&$zz69rhg!3o7lhum3'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'homeapp.context_processors.settings',
